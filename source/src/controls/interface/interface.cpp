...
const AdjValueParams adj_value_settings[] = {
        ...
        {"PEEP Limit (Floor)",  "PEEP",       "%.1f", "%ld",  cmh20,   PEEP_MIN,       PEEP_MAX,    DEF_PEEP,       1,   palette_color_1},
        {"PIP Limit (Ceiling)", "PIP",        "%.1f",  "%ld",  cmh20,   PIP_MIN,        PIP_MAX,     DEF_PIP,        1,   palette_color_1},
